        ...
        <header class="header">
            ...
            <div class="body">
                ...
                <form action='update_member.php' method='post'>
                    ...
                    <input type="text" name="mId"id="inputmId" class="form-control" placeholder="請輸入原來的身分證字號" required autofocus>
                    <br><br><br>
                    <label for="inputPassword" class="sr-only">密碼</label>
                    <input type="password" name="password"id="inputPassword" class="form-control" placeholder="請輸入新密碼" required>
                    <br><br><br>
                    <label for="inputmName" class="sr-only">姓名</label>
                    <input type="text" name="mName"id="inputmName" class="form-control" placeholder="請輸入新的姓名" required>
                    <br><br><br>
                    <label for="inputmPhone" class="sr-only">電話</label>
                    <input type="text" name="mPhone"id="inputmPhone" class="form-control" placeholder="請輸入新的電話" required>
                    <br><br><br>
                    <label for="inputemail" class="sr-only">email</label>
                    <input type="text" name="email"id="inputemail" class="form-control" placeholder="請輸入新的email" required>
                    <br><br><br>
